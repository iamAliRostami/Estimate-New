...
public class Mat {
        ...
        if (data == null || data.length % CvType.channels(t) != 0)
            throw new java.lang.UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            CvType.channels(t) + ")");
        nPutD(nativeObj, row, col, data.length, data);
    }
    ...
    public void put(int row, int col, float[] data) {
        ...
        if (CvType.depth(t) == CvType.CV_32F) {
            nPutF(nativeObj, row, col, data.length, data);
            return;
        }
    ...
    public void put(int row, int col, int[] data) {
        ...
        if (CvType.depth(t) == CvType.CV_32S) {
            nPutI(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
    ...
    public void put(int row, int col, byte[] data) {
        ...
        if (CvType.depth(t) == CvType.CV_8U || CvType.depth(t) == CvType.CV_8S) {
            nPutB(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
    ...
    public void put(int row, int col, byte[] data, int offset, int length) {
        int t = type();
        if (data == null || length % CvType.channels(t) != 0)
            throw new java.lang.UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            CvType.channels(t) + ")");
        if (CvType.depth(t) == CvType.CV_8U || CvType.depth(t) == CvType.CV_8S) {
            nPutBwOffset(nativeObj, row, col, length, offset, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
        ...
        if (data == null || data.length % CvType.channels(t) != 0)
            throw new java.lang.UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            CvType.channels(t) + ")");
        if (CvType.depth(t) == CvType.CV_8U || CvType.depth(t) == CvType.CV_8S) {
            nGetB(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
        ...
        if (data == null || data.length % CvType.channels(t) != 0)
            throw new java.lang.UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            CvType.channels(t) + ")");
        if (CvType.depth(t) == CvType.CV_32S) {
            nGetI(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
        ...
        if (data == null || data.length % CvType.channels(t) != 0)
            throw new java.lang.UnsupportedOperationException(
                    "Provided data element number (" +
                            ...
                            CvType.channels(t) + ")");
        if (CvType.depth(t) == CvType.CV_32F) {
            nGetF(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }
    ...
    public void get(int row, int col, double[] data) {
        ...
        if (CvType.depth(t) == CvType.CV_64F) {
            nGetD(nativeObj, row, col, data.length, data);
            return;
        }
        throw new java.lang.UnsupportedOperationException("Mat data type is not compatible: " + t);
    }

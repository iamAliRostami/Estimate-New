    ...
    public void onManagerConnected(int status) {
        switch (status) {
            ...
            case LoaderCallbackInterface.MARKET_ERROR: {
                ...
                MarketErrorMessage.setButton(AlertDialog.BUTTON_POSITIVE, "OK", (dialog, which) -> finish());
            ...
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION: {
                ...
                IncomatibilityMessage.setButton(AlertDialog.BUTTON_POSITIVE, "OK", (dialog, which) -> finish());
            ...
            default: {
                ...
                InitFailedDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK", (dialog, which) -> finish());
    ...
    public void onPackageInstall(final int operation, final InstallCallbackInterface callback) {
        switch (operation) {
            case InstallCallbackInterface.NEW_INSTALLATION: {
                ...
                InstallMessage.setButton(AlertDialog.BUTTON_POSITIVE, "Yes", (dialog, which) -> callback.install());

                InstallMessage.setButton(AlertDialog.BUTTON_NEGATIVE, "No", (dialog, which) -> callback.cancel());
            ...
            case InstallCallbackInterface.INSTALLATION_PROGRESS: {
                ...
                WaitMessage.setButton(AlertDialog.BUTTON_POSITIVE, "Wait", (dialog, which) -> callback.wait_install());
                WaitMessage.setButton(AlertDialog.BUTTON_NEGATIVE, "Exit", (dialog, which) -> callback.cancel());

...
//        this.levelOfDetails = new ArrayList<>();
//        levelOfDetails.add(new LevelOfDetail(1, 0.7031249999891485, 2.958293554545656E8));
//        levelOfDetails.add(new LevelOfDetail(2, 0.35156249999999994, 1.479146777272828E8));
//        levelOfDetails.add(new LevelOfDetail(3, 0.17578124999999997, 7.39573388636414E7));
//        levelOfDetails.add(new LevelOfDetail(4, 0.08789062500000014, 3.69786694318207E7));
//        levelOfDetails.add(new LevelOfDetail(5, 0.04394531250000007, 1.848933471591035E7));
//        levelOfDetails.add(new LevelOfDetail(6, 0.021972656250000007, 9244667.357955175));
//        levelOfDetails.add(new LevelOfDetail(7, 0.01098632812500002, 4622333.678977588));
//        levelOfDetails.add(new LevelOfDetail(8, 0.00549316406250001, 2311166.839488794));
//        levelOfDetails.add(new LevelOfDetail(9, 0.0027465820312500017, 1155583.419744397));
//        levelOfDetails.add(new LevelOfDetail(10, 0.0013732910156250009, 577791.7098721985));
//        levelOfDetails.add(new LevelOfDetail(11, 0.000686645507812499, 288895.85493609926));
//        levelOfDetails.add(new LevelOfDetail(12, 0.0003433227539062495, 144447.92746804963));
//        levelOfDetails.add(new LevelOfDetail(13, 0.00017166137695312503, 72223.96373402482));
//        levelOfDetails.add(new LevelOfDetail(14, 0.00008583068847656251, 36111.98186701241));
//        levelOfDetails.add(new LevelOfDetail(15, 0.000042915344238281406, 18055.990933506204));
//        levelOfDetails.add(new LevelOfDetail(16, 0.000021457672119140645, 9027.995466753102));
//        levelOfDetails.add(new LevelOfDetail(17, 0.000010728836059570307, 4513.997733376551));
//        levelOfDetails.add(new LevelOfDetail(18, 0.000005364418029785169, 2256.998866688275));
//        tileInfo = getTianDiTuLayerInfo();
//    }
//
//    private TileInfo getTianDiTuLayerInfo() {
//        return new TileInfo(_dpi, TileInfo.ImageFormat.PNG, levelOfDetails, origin, sp, _tileHeight, _tileWidth);
//    }
//
...
//        }
//        return new TileInfo(_dpi, TileInfo.ImageFormat.PNG, mainLevelOfDetail, ORIGIN_MERCATOR, SRID_MERCATOR, _tileHeight, _tileWidth);
//    }
//

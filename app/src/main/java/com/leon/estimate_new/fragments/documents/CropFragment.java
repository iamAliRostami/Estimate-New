...
public class CropFragment extends Fragment implements View.OnClickListener {
    ...
    private void initialize() {
        ...
        Observable.fromCallable(() -> {
                ...
                .subscribe((result) -> {
                    ...
                    binding.buttonCrop.setOnClickListener(this);
                    binding.buttonClose.setOnClickListener(this);
                    binding.imageViewRebase.setOnClickListener(this);
                    binding.imageViewInvert.setOnClickListener(this);
                    binding.imageViewRotate.setOnClickListener(this);
                });
    }
    @Override
    public void onClick(View v) {
       final int id = v.getId();
        ...
        } else if (id == R.id.image_view_rebase) {
            bitmapSelectedImage = bitmapTempOriginal.copy(bitmapTempOriginal
                    .getConfig(), true);
            isInverted = false;
            initialize();
        } else if (id == R.id.image_view_invert) {
            setProgressBar(true);
            Observable.fromCallable(() -> {
                        invertColor();
                        return false;
